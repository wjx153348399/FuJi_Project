CREATE TABLE station_directory_config (
  ...
  path_checked BIT NOT NULL CONSTRAINT DF_station_directory_config_path_checked DEFAULT (0),
  path_exists BIT NOT NULL CONSTRAINT DF_station_directory_config_path_exists DEFAULT (0),
  path_is_dir BIT NOT NULL CONSTRAINT DF_station_directory_config_path_is_dir DEFAULT (0),
  path_checked_at DATETIME NULL,
  path_check_message NVARCHAR(500) NULL,
